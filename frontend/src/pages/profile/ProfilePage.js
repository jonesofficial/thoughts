...
const ProfilePage = () => {
  const [postCount, setPostCount] = useState(0); // Store post count
    ...
    if (file) {
      ...
      reader.onload = () => {
        if (state === "coverImg") {
          ...
          console.log("Cover Image Base64: ", reader.result);
        }
        if (state === "profileImg") {
  ...
  return (
    <div className="flex-[4_4_0] border-r border-gray-100 min-h-screen">
      ...
      <div className="flex flex-col">
        {!isLoading && !isRefetching && user && (
          <>
            ...
            <div className="relative group/cover">
              ...
              />
              {/* USER AVATAR */}
              <div className="avatar absolute -bottom-16 left-1/2 transform -translate-x-1/2 flex items-center justify-center">
            ...
            <div className="flex justify-end px-4 mt-5">
              ...
              {(coverImg || profileImg) && (
                <button
                  ...
                  onClick={async () => {
                    console.log("Cover Image being sent: ", coverImg);
        ...
        {/* POSTS SECTION */}
        <div className="flex flex-col w-full max-w-5xl rounded-lg shadow-md p-4 shadow-gray-900">
          <Posts
            feedType={feedType}
            username={username}
            userId={user?._id}
